    ...
    <el-aside class="index-asdie">
      ...
      <div class="aside-meun">
        <ul>
          ...
          <!-- <li>
            <div class="meun-wuli meun-item" @click="showChildMeun(0)">物流管理</div>
            <transition name="height">
              <ul v-show='showChild[0]'>
                <li :class="{'meun-item-child':true, 'activeChild': activeChild1[0], 'move':move[0]}" @click="seletctThis(0,activeChild1,1)" @mouseover="asideMouserOver(0)" @mouseout="asideMouserOut(0)">添加物流信息</li>
                <li :class="{'meun-item-child':true, 'activeChild': activeChild1[1], 'move':move[1]}" @click="seletctThis(1,activeChild1,1)" @mouseover="asideMouserOver(1)" @mouseout="asideMouserOut(1)">我的添加记录</li>
              </ul>
            </transition>
          </li>
          <li>
            <div class="meun-wuli meun-item" @click="showChildMeun(1)">商品管理</div>
            <ul v-show='showChild[1]'>
              <li :class="{'meun-item-child':true, 'activeChild': activeChild2[0], 'move':move[0]}" @click="seletctThis(0,activeChild2,2)">添加商品</li>
            </ul>
          </li> -->
        </ul>
      </div>
